...
import { FaFacebookF, FaInstagram, FaLinkedinIn, FaGithub, FaTelegram } from "react-icons/fa";
...
function Home() {
  ...
  return (
    <div className="w-full h-full grid grid-cols-2 items-center px-16 py-15">
      ...
      <div className="flex flex-col gap-6 justify-center">
        ...
        <p className="text-gray-400 max-w-xl leading-relaxed">
          Passionate student developer who enjoys learning new technologies
          and building real projects step by step.
        </p>
  ...
  >
    <FaLinkedinIn />
      ...
      <div className="flex justify-center items-center">
        <div className="relative w-[360px] h-[400px] group animate-float">
          ...
          {/* HEXAGON IMAGE */}
          <div
            className="relative w-full h-full transition-all duration-500 group-hover:scale-[1.05]"
            style={{
              clipPath:
